 ...
 * @brief Configuration du projet RPL-MQoS
 * @version 1.0
 * @date 2024
 * 
 * Ce fichier contient les configurations spécifiques au projet
 * RPL-MQoS, incluant les paramètres RPL, QoS et les configurations
 * matérielles.
 */
